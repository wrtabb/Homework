...
\begin{homeworkProblem} 
	...
	\[
		\begin{split}
		\braket{\psi|S_z|\psi} =& \frac{\hbar}{2}\begin{pmatrix} -\sin\frac{\theta}{2} & \cos\frac{\theta}{2}\end{pmatrix}
