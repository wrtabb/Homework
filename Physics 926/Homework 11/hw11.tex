...
\begin{homeworkProblem}
	...
	\[
		...
		\end{split}
	\]
	The pion energy is high enough that we can assume $p_\pi \approx E_\pi$. If we also let the neutrino mass equal zero, which it approximately is compared with the other masses in this equation, so $p_\nu \approx E_\nu$. 
	\[
		\begin{split}		
		m_\pi^2-2(E_\pi E_\nu-E_\pi E_\nu \cos\theta) = m_\mu^2 \\
		m_\pi^2-m_\mu^2 = 2E_\pi E_\nu(1-\cos\theta) \\
		E_\nu = \frac{m_\pi^2-m_\mu^2}{2E_\pi(1-\cos\theta)}
		\end{split}
	\]
