...
\begin{homeworkProblem}
	...
	Here I will write the total wave function as a function of time but in the CP basis since we know that the $\pi^+\pi^-$ system is a CP eigenstate with an eigenvalue of +1.
	\[
		\begin{split}
	...
	\]
	\begin{figure}[h]
		\includegraphics[scale=0.2]{probEvolution}
		\centering
		\caption{Probability for $K^0$(red graph) and $\bar{K^0}$(blue graph) to decay to $\pi^+\pi^-$ as a function of time. }
		\label{probEvolution}
		\centering
	\end{figure}
