...
\\
	...
	\[
		...
		=& 2Tr \left[ \gamma^\mu\slashed{k}'\gamma^{\nu}\slashed{k} \right](c_v^2+c_A^2)
		\end{split}
	\]
	Putting all this together:
	\[
		\overline{\abs{\mathcal{M}}^2} = \frac{g_X^2}{8} \left( -g_{\mu\nu}+\frac{q_\mu q_\nu}{M_X^2} \right)Tr \left[ \gamma^\mu\slashed{k}'\gamma^{\nu}\slashed{k} \right](c_v^2+c_A^2)
	\]
\end{homeworkProblem}
