...
\begin{homeworkProblem}
	...
	\[
		\begin{split}
		\Gamma(q^+) =& \frac{G_FM_Z^3}{6\pi\sqrt{2}}(c_{v,q^+}^2+c_{A,q^+}^2) \\
		=& 0.095 \\
		\Gamma(q^-) =& \frac{G_FM_Z^3}{6\pi\sqrt{2}}(c_{v,q^-}^2+c_{A,q^-}^2) \\
		=& 0.12 \\
		\Gamma(l) =& \frac{G_FM_Z^3}{6\pi\sqrt{2}}(c_{v,l}^2+c_{A,l}^2) \\
		=& 0.083 \\
	...
	\[
		\begin{split} 
		\Gamma(l^+\nu)=&\frac{G_FM_W^3}{12\pi\sqrt{2}} \\
		=& 0.114\\
		\Gamma(u\bar{d})=&V_{ud}\frac{G_FM_W^3}{12\pi\sqrt{2}} \\
		=& 0.111\\
		\Gamma(u\bar{s})=&V_{us}\frac{G_FM_W^3}{12\pi\sqrt{2}} \\
		=& 0.0257\\
		\Gamma(u\bar{b})=&V_{ub}\frac{G_FM_W^3}{12\pi\sqrt{2}} \\
		=& 0.000400\\
		\Gamma(c\bar{d})=&V_{cd}\frac{G_FM_W^3}{12\pi\sqrt{2}} \\
		=& 0.0257\\
		\Gamma(c\bar{s})=&V_{cs}\frac{G_FM_W^3}{12\pi\sqrt{2}} \\
		=& 0.111\\
		\Gamma(c\bar{b})=&V_{cb}\frac{G_FM_W^3}{12\pi\sqrt{2}} \\
		=& 0.00470\\
		\Gamma_W = 0.785
		\end{split} 
	\]
	...
	\[
		\begin{split} 
		\Gamma(l^+\nu)/\Gamma_W =& 0.145 \\
		\Gamma(u\bar{d})/\Gamma_W =& 0.141 \\
		\Gamma(u\bar{b})/\Gamma_W =& 0.0327 \\
		\Gamma(u\bar{s}/\Gamma_W =& 0.000510 \\
		\Gamma(c\bar{d})/\Gamma_W =& 0.0327 \\
		\Gamma(c\bar{s})/\Gamma_W =& 0.141 \\
		\Gamma(c\bar{b})/\Gamma_W =& 0.00510 
		\end{split} 
	\]
\end{homeworkProblem}
