...
\begin{homeworkProblem}
	Show that any $2\times2$ matrix can be represented in terms of the identity matrix and the pauli matrices.
	\\
	\\
	\textbf{Solution}
	\\
	...
	\[
		...
		\end{split} 
	\]
	Assuming that the elements of $\vec{a}$ are complex, they can be used to define any number in the matrix $M$ which I defined above.
\end{homeworkProblem}
