...
\begin{homeworkProblem}
    ...
    \[
	    ...
	    \end{split}
    \]
    Since the final states all have comparable masses, the biggest contributor to their different rates is the Cabibbo angle.
    \\
    \\
    In the PDG, the decay rates are listed as $3.89\%$, $1.407\times 10^{-3}$, and $1.385 \times 10^{-4}$ listed in the same order I listed them above. My estimate of their relative rates is in the same order as in the PDG with $D^0\rightarrow K^- \pi^+$ being the most likely by far and $D^0\rightarrow \pi^- K^+$ being greatly suppressed. 
